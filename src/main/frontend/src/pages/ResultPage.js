    ...
    function getAnswer(){
        ...
        if (answer=="well"){
            ...
            paragraphOutput=
                ...
                "We recommend you to seek Professional help." +
            ...
            paragraphOutput=
                ...
                "We recommend you to to seek Professional help, and call the Suicide Prevention Hotline if necessary (131114). " +
                "Also please feel free to listen to the calming tunes in your Moments-to-Appreciate page " +
                "to help ease the distress";
            ...
            <Container fluid className="Result page">
                <Row>
                    <Col className="Result result">
                        {/*<h2>{getAnswer()}</h2>*/}
                        <h2>The diagnosis states that your result is {rD.getDiagnosis()}</h2>
